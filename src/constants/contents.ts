...
export const COUNTRIES = ["Pakistan", "Sauidi Arabia", "America", "Other"];
export const test = {
  propsalByCast: {
    title: "hello",
    content: ["hello", "test"],
...
export const MARRIAGE_PROPOSALS = [
  {
    title: "MARRIAGE PROPOSALS BY CAST",
    BY_CATEGORY: [
      "Ansari",
      "Arain",
      "Awan",
  ...
  {
    title: "PAKISTANI RISHTAY BY CITIES",
    BY_CATEGORY: ["Peshawar", "Lahore", "Karachi", "Islamabad", "Multan"],
  },
  {
    title: "MOST SEARCHED COUNTRIES",
    BY_CATEGORY: [
      "Pakistan",
      "Saudi Arabia",
      "America",
...
export const FEATURED_MEMBERS = [
  {
    ...
    gender: "Male",
    age: 31,
    profession: "Accounts/ Finance Professional",
